...
contains
    ...
    subroutine add_areatexto(id)
        ...
        new_contender%high = "150"
        new_contender%width = "150"
        new_contender%text = ""
    ...
    end subroutine add_areatexto

    subroutine print_areatexto()
    ...
    end subroutine print_areatexto


    subroutine areatexto_settext(id,text)
        character(len=*), intent(in) :: id 
    ...
    end subroutine areatexto_settext


    subroutine areatexto_setposition(id,position_x,position_y)
        character(len=*), intent(in) :: id 
    ...
    end subroutine areatexto_setposition

    

    function get_areatexto(id) RESULT(find)
        character(len=*), intent(in)::id
        logical :: find
        integer :: i
