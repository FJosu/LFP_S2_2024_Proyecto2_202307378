...
contains
    ...
    end subroutine add_texto

    subroutine print_texto()
    ...
    end subroutine print_texto

    

    subroutine texto_setAlignment(id,alignment)
        character(len=*), intent(in) :: id 
    ...
    end subroutine texto_setAlignment

    subroutine texto_settext(id,text)
        character(len=*), intent(in) :: id 
    ...
    end subroutine texto_settext


    subroutine texto_setposition(id,position_x,position_y)
        character(len=*), intent(in) :: id 
    ...
    end subroutine texto_setposition

    

    function get_texto(id) RESULT(find)
        character(len=*), intent(in)::id
        logical :: find
        integer :: i
