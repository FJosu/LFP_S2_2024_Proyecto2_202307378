...
contains
    ...
    end subroutine add_clave

    subroutine print_clave()
    ...
    end subroutine print_clave

    

    subroutine clave_setAlignment(id,alignment)
        character(len=*), intent(in) :: id 
    ...
    end subroutine clave_setAlignment

    subroutine clave_settext(id,text)
        character(len=*), intent(in) :: id 
    ...
    end subroutine clave_settext


    subroutine clave_setposition(id,position_x,position_y)
        character(len=*), intent(in) :: id 
    ...
    end subroutine clave_setposition

    

    function get_clave(id) RESULT(find)
        character(len=*), intent(in)::id
        logical :: find
        integer :: i
