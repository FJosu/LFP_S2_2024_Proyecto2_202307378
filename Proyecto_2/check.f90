...
contains
    ...
    subroutine check_setGrupo(id,group)
        character(len=*), intent(in) :: id 
    ...
    end subroutine check_setGrupo

    subroutine check_setMarcada(id,marked)
        character(len=*), intent(in) :: id 
    ...
    end subroutine check_setMarcada





    subroutine check_setposition(id,position_x,position_y)
        character(len=*), intent(in) :: id 
    ...
    end subroutine check_setposition

    

    function get_check(id) RESULT(find)
        character(len=*), intent(in)::id
        logical :: find
        integer :: i
